...
class ControllerSaleReferee extends Controller {
	public function index() {     
		$this->language->load('report/referee');
...
'href1'		=>$this->url->link('report/customer_data/', 'token=' . $this->session->data['token'] . '&customer_id=' . $ref['referrer_id'] . $url, 'SSL')
				);
}
/*		
...
//$this->data['customer_order1'] = $this->url->link('report/customer_data', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id']. $url, 'SSL');	
		...
		$this->template = 'report/referee.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
